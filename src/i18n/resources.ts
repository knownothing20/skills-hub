export const resources = {
  en: {
    translation: {
      ...
      subtitle: 'Manage, update, sync, organize, and safely remove Skills',
      workspace: 'Workspace',
      workspaceSubtitle: 'Local Skills manager',
      ...
      installSuccess: '"{{name}}" installed in the managed Skills directory',
      settings: 'Settings',
      settingsPageSubtitle: 'Configure appearance, discovery, fixed storage, network access, and safety boundaries.',
      ...
      settingsSectionNetworkDesc: 'Proxy settings for reviewed GitHub requests.',
      settingsSectionUpdates: 'Local safety controls',
      settingsSectionUpdatesDesc: 'Review the protections applied to local file changes.',
      safeBuildUpdatePolicy:
        'Skill update, sync, enable/disable, bulk actions, and scheduled updates are available. Removing or replacing managed content uses recoverable Trash with rollback; app self-update remains disabled in this source-only fork.',
      discoveryScan: {
      ...
      manageCenterHelp: 'Create, rename, and apply tags. Skill files stay untouched.',
      manageTabs: {
        tags: 'Tags',
        tools: 'Tools',
        updates: 'Updates',
      ...
      bulk: {
        ...
        updateProgress: '{{current}}/{{total}} Updating {{name}} ...',
        updateSuccess: 'Updated {{count}} skills and refreshed their existing sync targets.',
        updateFailedTitle: 'Failed to update {{name}}',
        noUpdateSources: 'None of the selected skills has a recorded Git or external local source.',
        tagsTitle: 'Set tags',
        ...
        deleteTitle: 'Move {{count}} skills to Trash?',
        deleteBody: 'The managed copies and sync targets created by this app will be moved to macOS Trash, so they remain recoverable.',
        deleteConfirm: 'Move {{count}} to Trash',
        deleteProgress: '{{current}}/{{total}} Moving {{name}} to Trash ...',
        deleteSuccess: 'Moved {{count}} skills to Trash.',
      ...
      safeInstallModeTitle: 'Managed install boundary',
      safeInstallModeDescription:
        'Installs into the fixed managed Skill directory and syncs only to the validated tool targets you select.',
      installScope: {
        title: 'Install scope',
      ...
      importSummary: 'Select Skills to import into the fixed managed directory.',
      importAndSync: 'Import selected Skills',
      close: 'Close',
      ...
      deleteTitle: 'Move skill to Trash?',
      deleteBody:
        'The managed copy and sync targets created by this app will be moved to macOS Trash.',
      cancel: 'Cancel',
      confirm: 'Confirm',
      ...
      skillsStorageHint:
        'Fixed safety policy: ~/.agents/skills is the only writable source of truth.',
      backupSectionTitle: 'Data Backup & Restore',
      backupSectionDesc: 'Automatically mirror all skill files, relationship tags, and database configs, with 1-click restoration.',
      backupAutoEnable: 'Enable Automatic Backup',
      backupAutoEnableHint: 'When enabled, app launch and skill changes automatically trigger silent background backups.',
      backupDirPath: 'Backup Destination Path',
      backupDirHint: 'Destination directory on local disk or external drive (default: D:\\GitHub\\skill-hub\\backup).',
      backupSelectDir: 'Browse...',
      backupNowBtn: '⚡ Backup Now',
      backupRestoreBtn: '📥 Restore from Backup',
      backupStatusLast: 'Last backup: {{time}} ({{count}} skills & relationships safely backed up)',
      backupStatusNever: 'No backup performed yet',
      backupSuccess: 'Backup successful! {{count}} skills backed up to {{path}}',
      backupFailed: 'Backup failed: {{error}}',
      restoreConfirm: 'Are you sure you want to restore from backup? Master skill files and database relationships will be restored.',
      restoreSuccess: 'Restore successful! {{count}} skills and relationships restored.',
      ...
      gitCacheCleanupDays: 'Manual cache cleanup',
      gitCacheCleanupHint:
        'Automatic cleanup is disabled. “Clean now” moves eligible cache entries to macOS Trash.',
      ...
      networkProxyHint:
        'Use a local proxy for search and Git requests. If port 7890 is detected on first launch, this is enabled automatically.',
      ...
      safeManualUpdateState: 'Protected',
      safeManualUpdateHint:
        'Each update is checked against the managed record and preserves the previous version in macOS Trash.',
      ...
      autoUpdateSkippedShort: 'Skipped',
      ...
      autoUpdateResultSkippedShort: 'Skipped {{count}}',
      autoUpdateResultIdleShort: 'No run yet',
      autoUpdateResultEquation: 'Checked = updated + skipped + failed',
      ...
      autoUpdateLastRun:
        'Last run: {{time}} · {{status}} · checked {{checked}}, updated {{updated}}, skipped {{skipped}}, failed {{failed}}',
      ...
      autoUpdateTaskTriggered:
        'Manual Skill update completed. Review the result shown here.',
      ...
      autoUpdateErrorRateLimited:
        '{{count}} GitHub request(s) were rate limited. Try again later or use the configured local proxy.',
      ...
      autoUpdateProgressSkipped: 'Skipped',
      ...
      autoUpdateSkippedTitle: 'Skipped · no external update source',
      ...
      update: 'Update',
      updateSourceUnavailable: 'No external source is recorded for this Skill',
      remove: 'Remove',
      ...
      processingTipShort: 'Validating and installing into the managed Skills directory',
      processingTipLong:
      ...
      delete: {
        confirmPrefix: 'Move ',
        confirmSuffix: '?',
        warningRemoveFromTools: 'Synced targets created by this app go to Trash',
        warningDeleteFromHub: 'The Hub copy goes to Trash and remains recoverable',
      ...
      detail: {
        ...
        ignoreSettings: 'Ignore Settings (.skillignore)',
        ignoreSettingsDesc: 'Select folders or files to ignore during checksum calculation and sync comparison (useful for keeping separate local keys, logs, or temporary caches).',
        ignoreFolderListTitle: 'Quick Select Items to Ignore',
        ignoreCustomRulesTitle: 'Custom Patterns & Wildcards',
        ignoreAddRulePlaceholder: 'e.g. *.key, .env*, local/',
        ignoreAddRuleButton: 'Add Rule',
        ignoreSaveButton: 'Save Ignore Settings',
        ignoreSavedSuccess: 'Ignore settings saved and applied',
      },
      sharedDirConfirm:
  ...
  zh: {
    translation: {
      ...
      subtitle: '管理、更新、同步、整理并安全移除 Skills',
      workspace: '工作区',
      workspaceSubtitle: '本地 Skills 管理器',
      addSkills: '添加 Skills',
      stats: {
        managed: '托管 Skills',
        global: '全局安装',
      ...
      moreTools: '+{{count}} 个',
      installSuccess: '“{{name}}”已安装到固定托管目录',
      settings: '设置',
      settingsPageSubtitle: '配置界面、发现扫描、固定存储、网络访问与安全边界。',
      ...
      settingsSectionNetworkDesc: '配置经过审查的 GitHub 请求代理。',
      settingsSectionUpdates: '本地安全控制',
      settingsSectionUpdatesDesc: '查看本地文件修改操作使用的保护措施。',
      safeBuildUpdatePolicy:
        '已开放 Skill 更新、同步、启用/停用、批量操作和定时更新。移除或替换托管内容时进入可恢复的废纸篓并支持失败回滚；这个源码 fork 不启用应用本体在线更新。',
      discoveryScan: {
        action: '扫描设置',
        title: '扫描设置',
      ...
      manageCenterHelp: '创建、重命名并批量应用标签；不会改动 Skill 文件。',
      manageTabs: {
        tags: '标签',
        tools: '工具',
        updates: '更新',
      ...
      bulk: {
        ...
        updateProgress: '{{current}}/{{total}} 正在更新「{{name}}」...',
        updateSuccess: '已更新 {{count}} 个 Skills，并刷新其现有同步目标。',
        updateFailedTitle: '更新「{{name}}」失败',
        noUpdateSources: '所选 Skills 都没有已记录的 Git 或外部本地来源，无法自动更新。',
        tagsTitle: '设置标签',
        ...
        deleteTitle: '将 {{count}} 个 Skills 移到垃圾篓？',
        deleteBody: '托管副本及本应用创建的同步目标都会移入 macOS 垃圾篓，仍可恢复。',
        deleteConfirm: '将 {{count}} 个移到垃圾篓',
        deleteProgress: '{{current}}/{{total}} 正在将「{{name}}」移到垃圾篓...',
        deleteSuccess: '已将 {{count}} 个 Skills 移到垃圾篓。',
      ...
      safeInstallModeTitle: '托管安装边界',
      safeInstallModeDescription:
        '安装到固定托管目录，并且只同步到你选择且经过校验的工具目标。',
      installScope: {
        title: '范围',
      ...
      importSummary: '选择要导入固定托管目录的 Skills。',
      importAndSync: '导入所选 Skills',
      close: '关闭',
      selectAll: '全选',
      ...
      linkLabel: 'link → {{target}}',
      deleteTitle: '移到垃圾篓？',
      deleteBody: '托管副本及本应用创建的同步目标都会移入 macOS 垃圾篓。',
      cancel: '取消',
      confirm: '确认',
      confirmRemove: '确认移除',
      maintenance: '维护',
      skillsStoragePath: 'Skills 存储路径',
      skillsStorageHint: '安全策略固定：~/.agents/skills 是唯一可写事实源。',
      backupSectionTitle: '数据备份与恢复',
      backupSectionDesc: '自动镜像备份全部技能文件、关系标签及数据库配置，支持随时一键快速恢复。',
      backupAutoEnable: '启用自动备份',
      backupAutoEnableHint: '开启后，启动或发生技能变动时，后台自动静默同步至备份目录。',
      backupDirPath: '备份存储路径',
      backupDirHint: '支持指定任意本地或外接驱动器路径，默认为 D:\\GitHub\\skill-hub\\backup。',
      backupSelectDir: '浏览...',
      backupNowBtn: '⚡ 立即备份一次',
      backupRestoreBtn: '📥 从备份一键恢复',
      backupStatusLast: '上次备份：{{time}}（共 {{count}} 个技能及关系已安全备份）',
      backupStatusNever: '尚未执行过备份',
      backupSuccess: '备份成功！已备份 {{count}} 个技能至 {{path}}',
      backupFailed: '备份失败：{{error}}',
      restoreConfirm: '确定要从备份目录恢复吗？中心母版目录中的文件将被覆盖，并恢复数据库关联关系。',
      restoreSuccess: '恢复成功！已成功还原 {{count}} 个技能及数据库关系。',
      ...
      gitCacheCleanupDays: '手动清理缓存',
      gitCacheCleanupHint:
        '自动清理已关闭。点击“立即清理”只会把符合条件的缓存移入 macOS 废纸篓。',
      ...
      networkProxy: '网络代理',
      networkProxyHint:
        '为搜索和 Git 请求使用本地代理。首次启动检测到 7890 端口时会自动开启。',
      ...
      safeManualUpdateState: '受保护',
      safeManualUpdateHint:
        '每次更新都会核对管理记录，并把旧版本保留在 macOS 废纸篓中。',
      ...
      autoUpdateResultSkippedShort: '跳过 {{count}}',
      autoUpdateResultIdleShort: '尚未运行',
      autoUpdateResultEquation: '检查数 = 更新成功 + 跳过 + 失败',
      ...
      autoUpdateLastRun:
        '上次运行：{{time}} · {{status}} · 检查 {{checked}}，更新 {{updated}}，跳过 {{skipped}}，失败 {{failed}}',
      autoUpdateLongRunningHint:
      ...
      autoUpdateTaskTriggered: '手动 Skill 更新已完成，请查看这里显示的结果。',
      autoUpdateErrorSummary:
      ...
      autoUpdateErrorRateLimited:
        '{{count}} 个 GitHub 请求触发限流。请稍后重试，或使用已配置的本地代理。',
      ...
      autoUpdateSkippedTitle: '已跳过 · 没有外部更新来源',
      ...
      copyFailed: '复制失败',
      update: '更新',
      updateSourceUnavailable: '这个 Skill 没有已记录的外部更新来源',
      remove: '移除',
      localTab: '本地目录',
      gitTab: 'Git 仓库',
      searchTab: '搜索',
      ...
      processingTipShort: '正在校验并安装到固定托管目录',
      ...
      delete: {
        confirmPrefix: '将 ',
        confirmSuffix: ' 移到垃圾篓？',
        warningRemoveFromTools: '本应用创建的同步目标会移到垃圾篓',
        warningDeleteFromHub: 'Hub 托管副本会移到垃圾篓，仍可恢复',
        confirmButton: '移到垃圾篓',
      },
      layout: {
        navDashboard: '概览',
      ...
      detail: {
        ...
        readError: '读取文件失败',
        fileCount: '{{count}} 个文件',
        ignoreSettings: '屏蔽设置 (.skillignore)',
        ignoreSettingsDesc: '勾选需要屏蔽的文件夹或文件。被屏蔽的项在计算指纹、同步比对时将被忽略（适合存放各软件独立 Key、本地缓存等）。',
        ignoreFolderListTitle: '快速勾选要屏蔽的文件夹与文件',
        ignoreCustomRulesTitle: '自定义通配符规则',
        ignoreAddRulePlaceholder: '例如：*.key, .env*, local/',
        ignoreAddRuleButton: '添加规则',
        ignoreSaveButton: '保存屏蔽设置',
        ignoreSavedSuccess: '屏蔽设置已保存并生效',
      },
      sharedDirConfirm:
